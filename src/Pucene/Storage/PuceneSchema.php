...
class PuceneSchema
{
    ...
    private function createDocumentFieldsTables(): void
    {
        ...
        $this->createDocumentFieldsTable(FieldType::KEYWORD, 'text');
    ...
    private function createDocumentFieldsTable(FieldType $type, $columnType, $options = []): void
    {
    ...
    public function getColumnType(FieldType $type)
    {
        return match ($type){
            FieldType::TEXT, FieldType::KEYWORD, FieldType::IDENTIFIER => 'text',
